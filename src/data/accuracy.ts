...
export const accuracyRecords: AccuracyRecord[] = [
  ...
  },
  {
    ...
    note: "初期実装の値が誤りと判明。正しいモンゴル語本名の表記は未確認のため空欄にしています。",
    correctedBy: "ユーザー指摘により要修正フラグ",
  },
  {
    id: "profile_birthdate",
    category: "プロフィール",
    field: "生年月日",
    currentValue: "1996年7月4日",
    status: "unconfirmed",
    note: "公式プロフィールでの確認が取れていません。",
  },
  {
    id: "profile_birthplace",
    category: "プロフィール",
    field: "出身地",
    currentValue: "モンゴル国ウランバートル市",
    status: "unconfirmed",
    note: "モンゴル出身であることは確かですが、具体的な出身市は未確認です。",
  },
  {
    id: "profile_stable",
    category: "プロフィール",
  ...
  },
  {
    ...
    currentValue: "157kg",
    status: "unconfirmed",
    note: "公式計測データとの照合が未完了。体重は場所によって変動します。",
  },
  {
    id: "profile_rank",
    category: "プロフィール",
  ...
  },
  {
    ...
    category: "プロフィール",
    field: "初土俵",
    currentValue: "2014年1月場所",
    status: "unconfirmed",
    note: "公式データベースとの照合が未完了。",
  },
